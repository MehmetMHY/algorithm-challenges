...
public class Stove {
	 ...
	 *
	 * displayStove() was written by Cody Ullestad & Mehmet Yilmaz,
	 * displayStove() is used to display the "state" of the burners.
	 */
	public void displayStove() {
		boolean redLight = false;
		for (int i=0; i<NUM_BURNERS; i++) {
			System.out.print("["+burners.get(i).getMySetting()+"].....");
			burners.get(i).printTemperature();
			System.out.print(Burner.printThis);
			if(Burner.printThis == "VERY HOT! DON'T TOUCH") {
				redLight = true;
			}
			System.out.println();
		}
